...
export default async function Home() {
	...
	const [establishments, recommendedEstablishments, confirmedBookings] = await Promise.all([
	...
	return (
		<div>
			...
			<div className="mt-6">
				...
				<div className="flex px-5 gap-4 overflow-x-auto [&::-webkit-scrollbar]:hidden">
					{establishments.map((establishment: Establishment) => (
						<div className="min-w-[167px] max-w-[167px]" key={establishment.id}>
			...
			<div className="mt-6 mb-[4.5rem]">
				...
				<div className="flex px-5 gap-4 overflow-x-auto [&::-webkit-scrollbar]:hidden">
					{recommendedEstablishments.map((establishment: Establishment) => (
						<div className="min-w-[167px] max-w-[167px]" key={establishment.id}>
							<EstablishmentItem establishment={establishment} />
						</div>
					))}
